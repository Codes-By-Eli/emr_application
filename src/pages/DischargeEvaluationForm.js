...
function DischargeEvaluationForm() {
  ...
  const [discharge_numbers, setDischargeNumbers] = useState([]);
 ...
 const [allValues, setAllValues] = useState({
  ...
  async function getDischargeNumbers()
  {
    var requestOptions = {
      method: "GET",
      headers: {
    ...
    const response = await fetch("http://127.0.0.1:5000/get_discharge_numbers", requestOptions);
    const data = await response.json();
    setDischargeNumbers(data.data);
  }
  ...
  async function getEvalInformation()
  {
    ...
    populateHandler(data.data2);
  }

  async function getChosenDischarge()
  {
    var requestOptions = {
      method: "POST",
      headers: {
    ...
    const response = await fetch("http://127.0.0.1:5000/get_chosen_discharge", requestOptions);
    const data = await response.json();
    if(!response.ok)
    {
      return;
        ...
        <div>
            ...
            <Grid container spacing={2}>
              ...
              <FormControl fullWidth>
                  <InputLabel id="init_med">Connect Initial Evaluation Medical Record</InputLabel>
                  <Select
                    labelId="init_med"
                    id="init_med_num"
                    inputProps={{
              ...
              <Grid item xs={5.25}>
              <FormControl fullWidth>
                  <InputLabel id="init_med">Edit Previous Discharge Evaluation</InputLabel>
                  <Select
                    labelId="init_med"
                    id="choice"
                    inputProps={{
                  ...
                  >
                    ...
                    {discharge_numbers?.map((record_number) => {
                      return <Option value={record_number.id}>{record_number.id} </Option>
                    })}
                  </Select>
                </FormControl>
              ...
              <TableRow>
                ...
                <TableCell align='center'> 
                  <TextField  
                    ...
                    value={allValues.toilet_transfer_disc || ''}
                    onChange={changeHandler}>
                  </TextField>
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell align='center'> 
                  <TextField  
                    ...
                    value={allValues.shower_transfer_disc || ''}
                    onChange={changeHandler}>
                  </TextField>
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell align='center'> 
                  <TextField  
                    ...
                    value={allValues.tub_transfer_disc || ''}
                    onChange={changeHandler}>
                  </TextField>
                </TableCell>
              </TableRow>
            ...
            <Grid item xs={11/3}>
              ...
              <Grid item xs={5}>
                <TextField label="Discharge Recommendations/Referrals:"
                  ...
                  multiline
                  value={allValues.discharge_recommendations_referrals || ''}
                  onChange={changeHandler}
                  inputProps={{ style: {height: 100} }}
                  style={{ padding: 1 }} />
              ...
              <Grid item xs={5}>
                <TextField label="Client Education:"
                  fullWidth
                  id='client_education'
                  value={allValues.client_education || ''}
                  multiline
                  onChange={changeHandler}
                  inputProps={{ style: {height: 100} }}
                  style={{ padding: 1 }} />
              ...
              <TextField label="Course of Rehabilitation"
                    fullWidth
                    id='course_of_rehab'
                    value={allValues.course_of_rehab || ''}
                    multiline
                    onChange={changeHandler}
                    inputProps={{ style: {height: 100} }}
                  style={{ padding: 1 }} />
